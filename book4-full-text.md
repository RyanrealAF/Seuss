...
Draft a 4-bar Boom-Bap verse locked strictly into the 90-BPM kick-snare pocket.
#### 2.6 Common Mistakes
...
Draft a 4-bar Drill verse applying Melancholic Meter to an anapestic skeleton.
#### 3.6 Common Mistakes
...
Compress a 12-syllable anapestic line into a triplet hi-hat grid measure.
#### 5.6 Common Mistakes
...
- **Drill:** 140 BPM, monotone spondaic stress, terminal rest (`∧`).
- **Trap:** 140 BPM, triplet hi-hat compression, iambic pickup.
#### 6.3 Theory: Framework Portability
Demonstrating that the Anapestic Anchor is a portable cognitive skeleton across all contemporary subgenres.
#### 6.4 Worked Examples: Side-by-Side Monospace Grid Comparison
Full 3-way comparative grid table mapping the same text across all 3 production environments.
#### 6.5 Exercise: 3-Way Adaptation Drill
Adapt an original 4-line couplet into all three subgenre delivery styles.
#### 6.6 Common Mistakes
...
### Chapter 7: Artist Attribution and Evidence Ethics
#### 7.1 Resolving Issue I-17: Attribution Protocol
Resolving Source-Issue I-17: Genre roles (Stabilizer, Subverter, Compressor) are **interpretive framework models (c)**, not empirical claims about specific artists' conscious intentions.
#### 7.2 Handling Real Artist Lyrics
- Quote short fragments only ($\le 15$ words).
- Never attribute unverified intent to named artists without a verified source.
- Describe controversial or sensitive material neutrally without slurs (Bible §2.3).
#### 7.3 Theory: Descriptive vs Prescriptive Analysis
Musicological analysis describes structural mechanics without speculating on private artistic motivation.
#### 7.4 Worked Examples: Attributed Fragment Analysis
Scanning a short attributed fragment using proper evidence labeling.
#### 7.5 Exercise: Attribution Audit Drill
Audit a paragraph to ensure no unverified artistic intent is asserted.
#### 7.6 Common Mistakes
Asserting that a named MC intentionally studied prosody manuals when writing a verse.
#### 7.7 Chapter Summary
Genre roles are interpretive framework models; commercial lyric analysis must follow strict attribution ethics.
#### 7.8 Cross-References
$\rightarrow$ Book 1, Evidence Notes; Book 5, Ethics.
#### 7.9 Evidence Notes & Flags
- Claim: Artist attribution ethics protocol | Type (c) Series protocol (Bible §8, I-17).
...
Design a 2-line metrical hook optimized for a Trap or Boom-Bap chorus.
#### 8.6 Common Mistakes
...
### Chapter 9: Cross-Genre Adaptation Drills
#### 9.1 The Adaptation Discipline
Practicing cross-genre adaptation trains working artists to deploy the Anapestic Anchor fluidly across any production beat.
#### 9.2 The 4-Step Adaptation Procedure
1. Draft acatalectic baseline. 2. Select target subgenre. 3. Apply subgenre delivery mechanics. 4. Audit grid compliance.
#### 9.3 Theory: Schema Transfer
Cross-genre adaptation builds schema transfer, expanding stylistic versatility.
#### 9.4 Worked Examples: Complete 4-Bar Adaptation Audit
Tracing an original 4-bar verse through complete Boom-Bap, Drill, and Trap transcriptions.
#### 9.5 Exercise: Full Adaptation Drill
Take an original 4-line quatrain and perform a complete 3-subgenre adaptation log.
#### 9.6 Common Mistakes
Failing to re-audit $RC_{grid}$ after adapting a verse to a new subgenre tempo.
#### 9.7 Chapter Summary
Cross-genre adaptation drills build versatile performance mastery across all hip-hop subgenres.
#### 9.8 Cross-References
$\rightarrow$ Book 4, Ch. 6; Book 5, Week 5.
#### 9.9 Evidence Notes & Flags
- Claim: Adaptation procedure | Type (c) Series methodology.

---

### Chapter 10: Subgenre Synthesis and Handoff to Pedagogy
#### 10.1 Book 4 Synthesis
Book 4 has mapped the Anapestic Anchor across Boom-Bap (Stabilizer), Drill (Subverter), and Trap (Compressor), establishing attribution ethics and metrical hooks.
#### 10.2 Guided Series Handoff to Book 5
- **Handoff to Book 5 (*Instructor's Manual*):** Book 5 schedules and assesses all material from Books 1–4 into a 6-week workshop curriculum.
#### 10.3 Theory: The Complete Series Through-Line
A stable childhood rhythm (Book 1) $\rightarrow$ Layered grooves (Book 2) $\rightarrow$ Hyperrhymes (Book 3) $\rightarrow$ Subgenre hooks (Book 4) $\rightarrow$ Classroom transfer (Book 5).
#### 10.4 Worked Examples: Master Series Synthesis Table
Comprehensive table mapping all 4 books into Book 5's 6-week workshop curriculum.
#### 10.5 Exercise: Synthesis Self-Audit
Perform a full Book 1–4 audit on a 16-bar original verse.
